        ...
        <div className='flex-grow flex justify-center h-screen items-center'>
          <div className="flex flex-col items-center px-5 max-w-[492px] w-full">
            ...
            <div className="mt-5  font-semibold text-sm leading-5 text-gray-600">
              ...
              <p className='text-center mt-2'>Login As</p><br />
              <Link to="/user-login" className='border border-black p-2 rounded-lg'>User</Link>
              <Link to="/company-login" className='ml-4 border border-black p-2 rounded-lg'>Company</Link>
            </div>
          </div>
        </div>
      </div>
