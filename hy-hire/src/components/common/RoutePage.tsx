      ...
      <div className='flex-grow flex justify-center items-center'>
        <div className="flex flex-col items-center px-5 max-w-[492px] w-full">
          ...
          <div className="w-full flex flex-col md:flex-row gap-5 mb-8">
            <div
              className={`flex flex-col grow pt-3 pr-3 pb-8 pl-6 w-full md:w-1/2 rounded shadow-sm cursor-pointer transition-colors duration-300 ${
          ...
          <button
            className="px-7 py-3 text-sm leading-5 rounded-2xl transition-colors duration-300 bg-green-700 text-white"
          >
            Join as a {selected}
          </button>
          <div className="mt-5 cursor-pointer font-semibold text-sm leading-5 text-gray-600">
