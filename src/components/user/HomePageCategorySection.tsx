        ...
        <>
            <div>
                    ...
                    <AnimatePresence>
                        {catergoryData.industries.slice(0, showAll ? catergoryData.industries.length : 8).map((data: any, index: number) => (
                            <motion.div
                                ...
                                className="w-full xl:max-w-[1400px] 2xl:max-w-[1600px] cursor-pointer max-md:max-w-full"
                                onClick={() => navigate(`joblistingbycategory/${data.sector}`)}
                            >
                ...
                <div className="flex justify-center">
                    <p onClick={handleToggle} className="text-maincolr underline text-lg cursor-pointer">
